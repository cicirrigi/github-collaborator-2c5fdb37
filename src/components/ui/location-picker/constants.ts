...
export const THEME_CLASSES = {
  ...
  suggestions: {
    container: 'absolute z-50 top-full left-0 right-0 mt-2 rounded-xl backdrop-blur-md bg-white/70 dark:bg-neutral-900/70 border border-neutral-200/30 dark:border-neutral-700/30 shadow-lg overflow-hidden max-h-60 overflow-y-auto',
