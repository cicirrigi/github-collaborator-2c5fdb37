...
export const TRAVEL_THEME = {
  sections: {
    ...
    stops: 'bg-gradient-to-br from-yellow-50/30 to-amber-50/30 dark:from-yellow-900/10 dark:to-amber-900/10 rounded-xl p-6',
    mapPreview: 'bg-white/50 dark:bg-neutral-800/50 rounded-lg p-4 border border-neutral-200/30 dark:border-neutral-700/30'
  },
  calendar: {
  ...
  counters: {
    ...
    buttonInactive: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-yellow-100 dark:hover:bg-yellow-900/20',
