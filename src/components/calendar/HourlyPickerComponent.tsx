...
export function HourlyPickerComponent() {
  ...
  return (
    <div className='relative'>
      <DatePillButton
        placeholder='Select Hourly Service Date & Time'
        value={
      ...
      {calendarOpen && (
        <div className='absolute bottom-full left-0 mb-2 z-[100] bg-white rounded-lg shadow-xl border'>
          <div className='p-2'>
            <h3 className='text-black text-sm mb-2'>Select Hourly Service Date & Time</h3>
