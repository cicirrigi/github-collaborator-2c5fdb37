  ...
  return (
    <div className='vl-card-flex' style={{ height: 'auto' }}>
      <CardHeader
        ...
        subtitle='Optional waypoints along your route'
      />
      <div className='vl-card-inner space-y-2'>
        {/* Header - Mini */}
        <div className='flex items-center gap-2'>
          <Route className='w-3 h-3 text-amber-200/60' />
          <span className='text-amber-100/80 text-xs font-light tracking-wider'>Waypoints</span>
        </div>
