...
class TypeScriptChecker {
  ...
  async runTypeScriptCheck() {
    ...
    try {
      ...
      console.log(`❌ TypeScript compilation failed: ${this.results.typecheck.errors.length} errors`)
    }
  ...
  generateRecommendations() {
    ...
    if (!this.results.build.passed) {
      recommendations.push('🏗️ Resolve build failures - check for missing dependencies or config issues')
    }
